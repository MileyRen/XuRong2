    ...
    return {
            ...
            preProcessing: function (op, callback) {
                ...
                */
                ...
                if(this.onlyChart === 'yes'){
                    ...
                    this.paddingTopDefault = 70;
                      if(this.title === '')this.paddingTopDefault = this.paddingTopDefault - 30;
                      if(this.subtitle === '')this.paddingTopDefault = this.paddingTopDefault - 15;
            ...
            drowHanrei: function () {
                ...
                function markerArc(that){
                    that.ctx.arc(
                        that.chartRight + 15, 
                        that.chartBottom -(lineHeight * i)- yOffset- 4,
                        radius, 
                        0, 
                        Math.PI*2
                    );
                ...
                function markerRect(that){
                        that.ctx.fillRect(
                          that.chartRight + 15 -radius, 
                          that.chartBottom -(lineHeight * i)- yOffset- 3 -radius,
                          radius*2,  
                          radius*2
                        );
                }
