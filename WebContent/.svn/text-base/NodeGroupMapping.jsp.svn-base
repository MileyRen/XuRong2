...
售货机组分配</font>(由groupInfo表导入)</p>
<p>&nbsp;</p>

<div class="content-box">
<div class="content-box-content"> 
<form name="search" action="<c:url value = '/do_map_searchgroupInGroupInfo_4?PageNo=0'/>" method="post" >
<table>
<tr style="background: #fff;">
<td  style="width:7%"></td>
<td  style="width:10%"><input class="text-input" style="width: 80%" type="text" name="groupId" value="${onginfo.groupId}" id="nodeId"/></td>
<td  style="width:10%"><input class="text-input" style="width: 80%" type="text" name="groupName" value="${onginfo.groupName}"/></td>
...
<div class="pagination">
	...
	<c:if test="${PageNo+1!='1'}">
	<a href="javascript:dosearch('do_map_searchgroupInGroupInfo_4?PageNo=0')">首页</a>
	<a href="javascript:dosearch('do_map_searchgroupInGroupInfo_4?PageNo=${PageNo-1}')">上一页</a>
	</c:if>
	...
	<c:if test="${length+1!='1'&&PageNo+1!=length}">
	<a href="javascript:dosearch('do_map_searchgroupInGroupInfo_4?PageNo=${PageNo+1}')">下一页</a>
	<a href="javascript:dosearch('do_map_searchgroupInGroupInfo_4?PageNo=${length-1}')">尾页</a>
	</c:if>
</div>
