...
<td  style="width:10%; padding-left: 0px"><input class="text-input" style="width: 80%" type="text" name="nodeId" value="${p.nodeId}"/></td>
<td  style="width:10%; padding-left: 0px"><input class="text-input" style="width: 80%" type="text" name="channelId" value="${p.channelId}"/></td>
<td  style="width:10%; padding-left: 0px"><input class="text-input" style="width: 80%" type="text" name="nodeGroupName" value="${p.nodeGroupName}"/></td>
<td  style="width:10%; padding-left: 0px"><input class="text-input" style="width: 80%" type="text" name="wareName" value="${p.wareName}"/></td>
<td  style="width:6%; padding-left: 0px"><input class="text-input" style="width: 80%" type="text" name="normalStock" value="${p.normalStock}"/></td>
...
<th  class="title" style="width:6%">当前数量</th>
<th  class="title" style="width:8%">最近加货数</th>
<th  class="title" style="width:6%">额定数量</th>
</tr>
</thead>
<tbody>
<c:forEach items="${cilist}" var="channel">
<tr>
	<td style="width:12%">${channel.nodeId}</td>
	<td style="width:10%">${channel.channelId}</td>
	<td style="width:10%">${channel.wareName}</td>
	<td style="width:10%">${channel.nodeGroupName}</td>
	<td style="width:6%">${channel.normalStock}</td>
	<td style="width:6%">${channel.currentNumber}</td>
	<td style="width:6%">${channel.incrementNumber}</td>
	<td style="width:10%">${channel.lastTime.toString().substring(0, 19)}</td>
</tr>
</c:forEach>
</tbody>
</table>
