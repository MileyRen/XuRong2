...
function doAjax(){
    ...
    jQuery.ajax({
        ...
        url: 'do_channelgroup_searchbyjson_3',
        data: JSON.stringify({
        	versionName: vname
        }),
        dataType: 'json',
        success: function(data){
           alert("success");
           //List<ChannelGroup> cglist = data.cglist;
           alert(data.cglist.size());
        },
    });
}
...
$(document).ready(function(){
	...
	$("#versionName").change(function(){
    	alert("change");
    	var vname = $("#versionName option:selected").attr("value");
    	if(vname!=""){
    		alert("to doAjax");
    		doAjax();
    		alert("end doAjax");
...
<body>
<div id="main-content">
<font  style="font-family:'微软雅黑'; font-size:30px">编辑机器货道组</font>
<p>&nbsp;</p>
<div class="content-box">
<form id="createdepot" name="createdepot" action="<c:url value='/do_channelgroupall_edit_0'/>" method="post" onsubmit="return checkform()">
<table id="sel">
  <tr>
    <td style="width:15%">请选择货道组版本名:</td>
    <td  style="width:25%">
